...
# Recipe:: zabbix
#
# Copyright 2016, vladhc@yahoo.com
#
...
Chef::Zabbix.percona(serverurl, node['fqdn'], credentials['zabbixConfig']['username'], credentials['zabbixConfig']['password'], port, release)
